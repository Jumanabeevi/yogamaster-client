...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "class/:id",
                element: <SingleClass/>,
                loader: ({ params }) => fetch(`https://yogamaster-server-jeo5.onrender.com/class/${params.id}`),
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://yogamaster-server-jeo5.onrender.com/users/${params.id}`),
            },
            {
                path: 'admin-home',
